...
> 状态：截至 2026-09-15（master `993c28d`），`docs/DESIGN-HERO-RHYTHM.md` §11 裁定 R1–R15 全部落地，`docs/CONTEXT.md` 53–64 是逐轮记录（64 = R15 攒下的真机验证已清完）。本文件只收**还没做完的事**，做完一条就删一条；新增待办也记在这里，不散落在 CONTEXT 里。
