...
describe("战斗编排层行为指纹", () => {
  ...
  it("3000 帧推进与基线一致", () => {
    expect(h.digest.join("\n")).toMatchInlineSnapshot(`
      ...
      f1500 ch=1 ct=250 k=14 gold=16 en=3 pr=32 gm=1 cl=0 mn=0 hp=108 lv=2 px=30,80 eh=98d3c914 ph=adf48f09
      f2000 ch=1 ct=333 k=17 gold=19 en=6 pr=32 gm=1 cl=0 mn=0 hp=100 lv=2 px=30,80 eh=cf4e65eb ph=45dffa4d
      f2500 ch=1 ct=417 k=22 gold=24 en=6 pr=32 gm=1 cl=0 mn=0 hp=100 lv=2 px=530,108 eh=9f1da37e ph=fea4a4b3
      f3000 ch=1 ct=500 k=30 gold=30 en=4 pr=31 gm=4 cl=0 mn=0 hp=116 lv=3 px=530,80 eh=dca85186 ph=b6732a25"
    `);
  });
